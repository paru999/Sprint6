...
<div class=" col-md-3">
 ...
 <img src= "image/${image}" vertical-align= "left" width= "20%"> ${UserName} ${LastName}  <br>
 ...
 <div class=" col-md-4">
   ...
   <div class=" col-md-3">
	...
	<div class=" col-md-3">
<a href="/spring2/unfriend?id=<c:out value="${listValue.getUserid()}"/>" style="color:grey;"><span class="glyphicon glyphicon-user" style="color:grey;" ></span>
