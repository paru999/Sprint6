...
<div class="row">
 ...
 <a href="confirmrequest" >Apporve Friends</a>
   ...
   <div class=" col-md-3">
	...
	<div class=" col-md-4">
	<a href="/spring2/add?id=<c:out value="${listValue.getUserid()}"/>" style="color:grey;"><span class="glyphicon glyphicon-user" style="color:grey;" ></span>
<i class="glyphicon glyphicon-plus" style="color:grey;"></i>addfriend</a>
